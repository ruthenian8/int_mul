...
dataset %>% 
  ...
  labs(title = "MUL by genders", y = "Mean utterance len.") + 
...
dataset %>% 
  ...
  geom_boxplot(notch = TRUE) + 
  stat_summary(fun=mean, geom="point", shape=20, size=6, color="white")+
  labs(title = "MSL by genders", y = "Mean sent. len.") + 
  theme_economist(base_size = 55) + 
  theme(axis.text.x = element_text(vjust = 6),
        axis.text.y = element_text(hjust = 2)) + 
 ...
 * Daniel, M. A., Zelenkov, Yu. G. (2012). NRC as an intrument for sociolinguistic research. Episode IV: speaker gender and utterance length. In: Computational linguistics and intellectual technologies. Proceedings of "Dialogue-2012". 11. Moscow: RSUH. pp. 112-121.
